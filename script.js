...
function preserveScroll(fn) {
    ...
    const restore = () => { if (window.scrollY !== scrollY) window.scrollTo({ top: scrollY, behavior: 'instant' }); };
...
function getOverlaySlotHTML(id, page) {
    ...
    if (page === 2) {
        ...
        const _ownerName   = isWildKami ? (_wildOwner.accountName || '—') : (_kamiAccount.accountName || '—');
        const _accountIdx  = isWildKami
            ? (_wildOwner.accountIndex != null ? `#${_wildOwner.accountIndex}` : '—')
...
async function refreshData() {
    ...
    const pinScroll = () => { if (window.scrollY !== savedScrollY) window.scrollTo({ top: savedScrollY, behavior: 'instant' }); };
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (scToggleBtn) {
        ...
        if (!document.getElementById('sc-loading-hint-style')) {
            ...
            s.textContent = `#sc-loading-hint{position:absolute;bottom:calc(100% + 6px);left:50%;transform:translateX(-50%);font-size:9px;white-space:nowrap;color:#000;padding:3px 6px;pointer-events:none;opacity:0;transition:opacity 0.2s ease;}#sc-loading-hint.visible{opacity:1;}`;
        ...
        scToggleBtn.addEventListener('click', () => {
            ...
            if (!artwork) { player.classList.add('sc-open'); return; }
            // Already loaded (cached or complete)
            if (artwork.src && artwork.src !== window.location.href && artwork.complete) {
    ...
    if (scContainer) {
        ...
        scIframe.src = 'https://w.soundcloud.com/player/?url=https%3A//soundcloud.com/asphodel-332772510/sets/complete-soundtrack&auto_play=false&hide_related=true&show_comments=false&show_user=true&show_reposts=false';
        Object.assign(scIframe.style, { position: 'absolute', width: '1px', height: '1px', top: '-9999px', left: '-9999px', visibility: 'hidden', pointerEvents: 'none' });
        ...
        const initWidget = () => {
            const BASE_IMG_URL = "https://raw.githubusercontent.com/Asphodel-OS/kamigotchi/refs/heads/main/packages/client/src/assets/images/rooms/";
            const trackKeyMap = {
            ...
            const roomMap = {
                ...
                '02-1': ["2_tree-tunnel/backgrounds/glow-a.png", "2_tree-tunnel/backgrounds/glow-b.png", "2_tree-tunnel/backgrounds/room2a1-christmas.png", "2_tree-tunnel/backgrounds/room2b1-christmas.png"],
                '03-1': ["3_gate/backgrounds/room3a_zev.png", "3_gate/backgrounds/room3b_zev.png"],
                '02-2': ["2_tree-tunnel/backgrounds/glow-c.png", "2_tree-tunnel/backgrounds/room2c1-christmas.png"],
                '03-2': ["3_gate/backgrounds/room3c_zev.png"],
                '04': ["4_junkyard/backgrounds/room4a.gif", "4_junkyard/backgrounds/room4b.gif", "4_junkyard/backgrounds/room4c.gif"],
                '05-1': ["5_restricted/backgrounds/room5a_rob.png", "5_restricted/backgrounds/room5b_rob.png"],
                '06-1': ["6_office-front/backgrounds/room6a.gif", "6_office-front/backgrounds/room6b.gif"],
                '05-2': ["5_restricted/backgrounds/room5c_rob.png"],
                '06-2': ["6_office-front/backgrounds/room6c.gif"],
                '09': ["9_forest/backgrounds/playtest-a.png", "9_forest/backgrounds/playtest-b.png", "9_forest/backgrounds/playtest-c.png"],
                '33': ["33_forest-entrance/backgrounds/playtest-a.png", "33_forest-entrance/backgrounds/playtest-b.png", "33_forest-entrance/backgrounds/playtest-c.png"],
                '36': ["36_forest-road-ii/backgrounds/playtest-a.png", "36_forest-road-ii/backgrounds/playtest-b.png", "36_forest-road-ii/backgrounds/playtest-c.png"],
                '48': ["48_forest-road-iv/backgrounds/playtest-a.png", "48_forest-road-iv/backgrounds/playtest-b.png", "48_forest-road-iv/backgrounds/playtest-c.png"],
                '10': ["10_forest-insect/backgrounds/playtest-a.png", "10_forest-insect/backgrounds/playtest-b.png", "10_forest-insect/backgrounds/playtest-c.png"],
                '35': ["35_forest-road-i/backgrounds/playtest-a.png", "35_forest-road-i/backgrounds/playtest-b.png", "35_forest-road-i/backgrounds/playtest-c.png"],
                '50': ["50_ancient_forest_entrance/backgrounds/playtest-a.png", "50_ancient_forest_entrance/backgrounds/playtest-b.png", "50_ancient_forest_entrance/backgrounds/playtest-c.png"],
                '51': ["51_scrap_littered_undergrowth/backgrounds/playtest-a.png", "51_scrap_littered_undergrowth/backgrounds/playtest-b.png", "51_scrap_littered_undergrowth/backgrounds/playtest-c.png"],
                '61': ["61_decaying-forest-path/backgrounds/room61a.png", "61_decaying-forest-path/backgrounds/room61b.png", "61_decaying-forest-path/backgrounds/room61c.png"],
                '11': ["11_waterfall/backgrounds/playtest-a.png", "11_waterfall/backgrounds/playtest-b.png", "11_waterfall/backgrounds/playtest-c.png"],
                '12': ["12_junkyard-machine/backgrounds/playtest-a.png", "12_junkyard-machine/backgrounds/playtest-b.png", "12_junkyard-machine/backgrounds/playtest-c.png"],
                '34': ["34_deeper-into-scrap/backgrounds/playtest-a.png", "34_deeper-into-scrap/backgrounds/playtest-b.png", "34_deeper-into-scrap/backgrounds/playtest-c.png"],
                '58': ["58_mouth-of-scrap/backgrounds/room58a.png", "58_mouth-of-scrap/backgrounds/room58b.png", "58_mouth-of-scrap/backgrounds/room58c.png"],
                '60': ["60_scrap-trees/backgrounds/room60a.png", "60_scrap-trees/backgrounds/room60b.png", "60_scrap-trees/backgrounds/room60c.png"],
                '13': ["13_giftshop/backgrounds/playtest.png"],
                '25': ["25_lost-skeleton/backgrounds/playtest-a.png", "25_lost-skeleton/backgrounds/playtest-b.png", "25_lost-skeleton/backgrounds/playtest-c.png"],
                '37': ["37_forest-road-iii/backgrounds/playtest-a.png", "37_forest-road-iii/backgrounds/playtest-b.png", "37_forest-road-iii/backgrounds/playtest-c.png"],
                '49': ["49_clearing/backgrounds/room49a2.png", "49_clearing/backgrounds/room49b2.png", "49_clearing/backgrounds/room49c2.png"],
                '26': ["26_trash-strewn-graves/backgrounds/playtest-a.png", "26_trash-strewn-graves/backgrounds/playtest-b.png", "26_trash-strewn-graves/backgrounds/playtest-c.png"],
                '53': ["53_blooming-tree/backgrounds/playtest-a.png", "53_blooming-tree/backgrounds/playtest-b.png", "53_blooming-tree/backgrounds/playtest-c.png"],
                '29': ["29_road-out-of-woods/backgrounds/playtest-a.png", "29_road-out-of-woods/backgrounds/playtest-b.png", "29_road-out-of-woods/backgrounds/playtest-c.png", "29_road-out-of-woods/backgrounds/room29c-christmas.gif"],
                '30': ["30_scrapyard-entrance/backgrounds/playtest-a.png", "30_scrapyard-entrance/backgrounds/playtest-b.png", "30_scrapyard-entrance/backgrounds/playtest-c.png"],
                '31': ["31_scrapyard-exit/backgrounds/playtest-a.png", "31_scrapyard-exit/backgrounds/playtest-b.png", "31_scrapyard-exit/backgrounds/playtest-c.png"],
                '32': ["32_road-to-labs/backgrounds/playtest-a.png", "32_road-to-labs/backgrounds/playtest-b.png", "32_road-to-labs/backgrounds/playtest-c.png"],
                '47': ["47_scrap-paths/backgrounds/playtest-a.png", "47_scrap-paths/backgrounds/playtest-b.png", "47_scrap-paths/backgrounds/playtest-c.png"],
                '52': ["52_airplane_crash/backgrounds/playtest-a.png", "52_airplane_crash/backgrounds/playtest-b.png", "52_airplane_crash/backgrounds/playtest-c.png"],
                '54': ["54_plane_interior/backgrounds/playtest-a.png", "54_plane_interior/backgrounds/playtest-b.png", "54_plane_interior/backgrounds/playtest-c.png"],
                '55': ["55_shady-path/backgrounds/room55a.png", "55_shady-path/backgrounds/room55b.png", "55_shady-path/backgrounds/room55c.png", "55_shady-path/backgrounds/room55c-christmas.gif"],
                '56': ["56_butterfly-forest/backgrounds/room56a.png", "56_butterfly-forest/backgrounds/room56b.png", "56_butterfly-forest/backgrounds/room56c.png", "56_butterfly-forest/backgrounds/room56c-christmas.gif"],
                '57': ["57_river-crossing/backgrounds/room57a.gif", "57_river-crossing/backgrounds/room57b.gif", "57_river-crossing/backgrounds/room57c.gif", "57_river-crossing/backgrounds/room57c-christmas.gif"],
                '63': ["63_deeper-forest-paths/backgrounds/room63a.png", "63_deeper-forest-paths/backgrounds/room63b.png", "63_deeper-forest-paths/backgrounds/room63c.png"],
                '19': ["19_temple-of-the-wheel/backgrounds/room19a.png"],
                '62': ["62_centipedes/backgrounds/room62a.png", "62_centipedes/backgrounds/room62b.png", "62_centipedes/backgrounds/room62c.png"],
                '64': ["64_burning-room/backgrounds/room64a.gif", "64_burning-room/backgrounds/room64b.gif", "64_burning-room/backgrounds/room64c.gif"],
                '65': ["65_forest-hut/backgrounds/room65a.png", "65_forest-hut/backgrounds/room65b.png", "65_forest-hut/backgrounds/room65c.png"],
                '66': ["66_trading-room/backgrounds/room66a.png", "66_trading-room/backgrounds/room66b.png", "66_trading-room/backgrounds/room66c.png"]
            };
            ...
            const renderDots = (images, activeIndex) => {
                ...
                if (images.length <= 1) { dotsContainer.style.display = 'none'; return; }
                ...
                images.forEach((_, i) => {
                    ...
                    dot.addEventListener('click', () => {
                        ...
                        artworkEl.src = images[i];
                        renderDots(images, i);
                        // Resume auto-switching from the clicked index
                        artworkInterval = setInterval(() => {
                            currentArtworkIndex = (currentArtworkIndex + 1) % images.length;
                            artworkEl.src = images[currentArtworkIndex];
            ...
            const updateArtwork = (sound) => {
                if (!artworkEl || !sound) return;

                // IMPORTANT: Clear the old timer whenever a new track starts
                // so they don't overlap and glitch out!
                if (artworkInterval) {
                    clearInterval(artworkInterval);
                    artworkInterval = null;
                }

                const overrideImages = artworkOverrides[sound.title];

                if (overrideImages && overrideImages.length > 0) {
                    // ONLY RESET INDEX IF THE TRACK CHANGED
                    if (sound.title !== currentArtworkTitle) {
                        currentArtworkIndex = 0;
                    }
                    currentArtworkTitle = sound.title;
                    artworkEl.src = overrideImages[currentArtworkIndex];
                    renderDots(overrideImages, currentArtworkIndex);

                    // If there is more than 1 image, start the auto-switching timer
                    if (overrideImages.length > 1) {
                        artworkInterval = setInterval(() => {
                            // Move to the next index, and loop back to 0 if we hit the end
                            currentArtworkIndex = (currentArtworkIndex + 1) % overrideImages.length;
                            artworkEl.src = overrideImages[currentArtworkIndex];
                            renderDots(overrideImages, currentArtworkIndex);
                        }, SWITCH_SPEED_MS);
                    }
                    ...
                    artworkEl.src = url.replace('-large', '-t500x500');
                    renderDots([], 0);
                }
            };
            ...
            // Create dots container and insert it right after the artwork element
            if (artworkEl && !scContainer.querySelector('.sc-artwork-dots')) {
                dotsContainer = document.createElement('div');
                dotsContainer.className = 'sc-artwork-dots';
                dotsContainer.style.cssText = 'position:absolute;bottom:0;left: 50%;transform: translateX(-50%);display:none;justify-content:center;align-items:center;gap:5px;padding:5px 0;';
                artworkEl.insertAdjacentElement('afterend', dotsContainer);

                // Inject dot styles once
                if (!document.getElementById('sc-artwork-dots-style')) {
                    const s = document.createElement('style');
                    s.id = 'sc-artwork-dots-style';
            ...
            widget.bind(SC.Widget.Events.READY, () => {
                ...
                const loadSounds = () => {
                    widget.getSounds(sounds => {
                        const allLoaded = sounds.length > 0 && sounds.every(s => s.title);
                        if (!allLoaded) {
                        ...
                        select.addEventListener('change', () => {
                            ...
                            if (seekDur) seekDur.textContent = formatTime(sounds[index].duration);
                        });
                        ...
                        if (seekDur) seekDur.textContent = formatTime(sounds[randomIndex].duration);
                    });
                };
                loadSounds();
                ...
                setTimeout(() => {
                    widget.getDuration(d => {
                        if (d) { cachedDuration = d; if (seekDur) seekDur.textContent = formatTime(d); }
                    });
                }, 1000);
            });
            ...
            widget.bind(SC.Widget.Events.PLAY, () => {
                ...
                if (!userStartedPlayback) { widget.pause(); return; }
                if (playBtn) {
                    playBtn.setAttribute('data-state', 'playing');
                    playBtn.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 32 32"><path fill="currentColor" d="M14 10h-2v12h2zm6 0h-2v12h2z"/><path fill="currentColor" d="M16 4A12 12 0 1 1 4 16A12 12 0 0 1 16 4m0-2a14 14 0 1 0 14 14A14 14 0 0 0 16 2"/></svg>';
                    playBtn.setAttribute('aria-label', 'Pause');
                }
                widget.getCurrentSoundIndex(i => {
                    if (scContainer._scSelect) scContainer._scSelect.value = i;
                });
                widget.getCurrentSound(sound => { updateArtwork(sound); });
                widget.getDuration(d => {
                    if (d) { cachedDuration = d; if (seekDur) seekDur.textContent = formatTime(d); }
                });
            });
            ...
            if (seekBar) {
                ...
                seekBar.addEventListener('input', () => {
                    if (cachedDuration) {
                        ...
                        if (seekCur) seekCur.textContent = formatTime((seekBar.value / 100) * cachedDuration);
                    }
                });
                seekBar.addEventListener('mouseup', () => {
                    if (cachedDuration) widget.seekTo((seekBar.value / 100) * cachedDuration);
